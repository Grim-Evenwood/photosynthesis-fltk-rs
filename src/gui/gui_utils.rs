...
pub fn get_default_grid_width() -> i32 {get_default_win_width() - 400}
pub fn get_default_grid_height() -> i32 {get_default_win_height()-get_default_menu_height() - get_default_tab_padding() - 225}
pub fn get_max_grid_button_width() -> i32 {30}
pub fn get_max_grid_button_height() -> i32 {15}
pub fn get_default_txt_width() -> i32 {(get_default_win_width() / 6) - (get_default_txt_padding() * 3 / 2)}
pub fn get_default_txt_height() -> i32 {25}
pub fn get_default_txt_padding() -> i32 {10}
pub fn get_default_grid_padding() -> i32 {100}
